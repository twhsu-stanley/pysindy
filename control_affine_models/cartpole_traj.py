...
with open('./control_affine_models/saved_models/model_cartpole_traj_X_sindy', 'wb') as file:
    pickle.dump(model_saved, file)

# Testing
with open('./control_affine_models/saved_models/' + 'model_cartpole_traj_X_sindy', 'rb') as file:
